<template>
	<div id="tabbar"> 	
		<mt-tabbar>
		<!-- 教官 -->
			<router-link :to="{path:'/MasterCourse',query:{'userId':userId}}">
			...
			<!-- 教官 -->
			<router-link :to="{path:'/Grade',query:{'userId':userId}}">
			...
			<!-- 教官 -->
			<router-link :to="{path:'/MasterPersonal',query:{'userId':userId}}">
